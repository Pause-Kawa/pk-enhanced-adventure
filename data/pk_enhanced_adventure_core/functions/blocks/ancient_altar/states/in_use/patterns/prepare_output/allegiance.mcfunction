...
data modify storage pk_enhanced_adventure:data Temp.Item.tag.pkBewitchments.Allegiance set value 1b
data modify storage pk_enhanced_adventure:data Temp.Item.tag.display.Lore prepend value '{"text":"Allegiance","color":"yellow","italic":false}'
