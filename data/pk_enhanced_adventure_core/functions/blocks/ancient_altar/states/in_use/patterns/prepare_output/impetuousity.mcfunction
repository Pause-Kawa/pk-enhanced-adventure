...
data modify storage pk_enhanced_adventure:data Temp.Item.tag.pkBewitchments.Impetuousity set value 1b
data modify storage pk_enhanced_adventure:data Temp.Item.tag.display.Lore prepend value '{"text":"Impetuousity","color":"yellow","italic":false}'
