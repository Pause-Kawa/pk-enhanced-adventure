...
data modify storage pk_enhanced_adventure:data Temp.Item.tag.pkBewitchments.Robustness set value 1b
data modify storage pk_enhanced_adventure:data Temp.Item.tag.display.Lore prepend value '{"text":"Robustness","color":"yellow","italic":false}'
