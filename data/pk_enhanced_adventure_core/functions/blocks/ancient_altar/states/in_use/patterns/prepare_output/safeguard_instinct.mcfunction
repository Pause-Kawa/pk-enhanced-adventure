...
data modify storage pk_enhanced_adventure:data Temp.Item.tag.pkBewitchments.SafeguardInstinct set value 1b
data modify storage pk_enhanced_adventure:data Temp.Item.tag.display.Lore prepend value '{"text":"Safeguard Instinct","color":"yellow","italic":false}'
