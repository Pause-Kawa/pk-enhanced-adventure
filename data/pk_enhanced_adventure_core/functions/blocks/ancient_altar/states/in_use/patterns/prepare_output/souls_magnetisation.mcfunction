...
data modify storage pk_enhanced_adventure:data Temp.Item.tag.pkBewitchments.SoulsMagnetisation set value 1b
data modify storage pk_enhanced_adventure:data Temp.Item.tag.display.Lore prepend value '{"text":"Souls Magnetisation","color":"yellow","italic":false}'
