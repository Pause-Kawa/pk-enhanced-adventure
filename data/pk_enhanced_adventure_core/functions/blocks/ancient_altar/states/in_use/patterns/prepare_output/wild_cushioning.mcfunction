...
data modify storage pk_enhanced_adventure:data Temp.Item.tag.pkBewitchments.WildCushioning set value 1b
data modify storage pk_enhanced_adventure:data Temp.Item.tag.display.Lore prepend value '{"text":"Wild Cushioning","color":"yellow","italic":false}'
