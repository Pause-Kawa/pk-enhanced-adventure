...
execute positioned ~-1.5 ~-1.5 ~-1.5 as @e[type=wither_skeleton,tag=pk_higuru_guardian,dx=2,dy=2,dz=2,limit=1] run function pk_enhanced_adventure_core:entities/higuru_guardian/behavior/phase/3/reduce_shield_level
