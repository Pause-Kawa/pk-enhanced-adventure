...
summon small_fireball ^ ^ ^0.5 {Tags:["pk_higuru_guardian_projectile","pk_small","pk_current_projectile"],Passengers:[{id:"minecraft:marker",Tags:["pk_higuru_guardian_projectile_marker","pk_small"]}]}
