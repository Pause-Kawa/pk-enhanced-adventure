...
execute if score $out pk.enhanced_adventure.random matches ..500 run data modify storage pk_enhanced_adventure:data Temp.Recipes append value {xp:10,priceMultiplier:0.2f,maxUses:12,buy:{id:"minecraft:emerald",Count:5b},buyB:{id:"minecraft:sugar",Count:1b},sell:{id:"minecraft:potion",Count:1b,tag:{display:{Name:'{"text":"Delicious Potion of Swiftness"}'},CustomPotionEffects:[{Id:1b,Amplifier:1b,Duration:5400}],CustomPotionColor:8303306}}}
execute if score $out pk.enhanced_adventure.random matches 501.. run data modify storage pk_enhanced_adventure:data Temp.Recipes append value {xp:10,priceMultiplier:0.2f,maxUses:12,buy:{id:"minecraft:emerald",Count:5b},buyB:{id:"minecraft:magma_cream",Count:1b},sell:{id:"minecraft:potion",Count:1b,tag:{display:{Name:'{"text":"Delicious Potion of Fire Resistance"}'},CustomPotionEffects:[{Id:12b,Amplifier:0b,Duration:19200}],CustomPotionColor:15244603}}}
...
function pk_enhanced_adventure_core:helpers/random/uniform_0_1000
execute if score $out pk.enhanced_adventure.random matches ..500 run data modify storage pk_enhanced_adventure:data Temp.Recipes append value {xp:10,priceMultiplier:0.2f,maxUses:12,buy:{id:"minecraft:emerald",Count:5b},buyB:{id:"minecraft:ghast_tear",Count:1b},sell:{id:"minecraft:potion",Count:1b,tag:{display:{Name:'{"text":"Delicious Potion of Regeneration"}'},CustomPotionEffects:[{Id:10b,Amplifier:1b,Duration:5400}],CustomPotionColor:13721262}}}
execute if score $out pk.enhanced_adventure.random matches 501.. run data modify storage pk_enhanced_adventure:data Temp.Recipes append value {xp:10,priceMultiplier:0.2f,maxUses:12,buy:{id:"minecraft:emerald",Count:5b},buyB:{id:"minecraft:magma_cream",Count:1b},sell:{id:"minecraft:potion",Count:1b,tag:{display:{Name:'{"text":"Delicious Potion of Water Breathing"}'},CustomPotionEffects:[{Id:13b,Amplifier:0b,Duration:19200}],CustomPotionColor:3101852}}}
