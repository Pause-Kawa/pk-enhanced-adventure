...
data modify storage pk_enhanced_adventure:data Temp.Recipes append value {xp:15,priceMultiplier:0.2f,maxUses:16,buy:{id:"minecraft:emerald",Count:7b},buyB:{id:"minecraft:cookie",Count:16b},sell:{id:"minecraft:potion",Count:1b,tag:{pkTeleportationPotion:1b,CustomPotionColor:8246765,Enchantments:[{}],display:{Name:'{"text":"Potion of Teleportation","italic":false}',Lore:['"Teleport to your memorized point"']},HideFlags:33}}}
