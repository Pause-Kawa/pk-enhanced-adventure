...
# Animations
execute at @e[type=wither_skeleton,distance=..50] unless entity @s[tag=!pk_wildling_guardian,tag=!pk_wildling_fraudster] run playsound entity.wither.shoot ambient @a[distance=..50] ~ ~ ~ 0.5 1
execute at @e[type=wither_skeleton,distance=..50] unless entity @s[tag=!pk_wildling_guardian,tag=!pk_wildling_fraudster] run particle soul_fire_flame ~ ~1 ~ 0.5 0.5 0.5 0.1 50
