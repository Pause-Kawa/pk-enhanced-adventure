...
execute as @a[tag=pk_target_player] facing entity @s eyes run function pk_enhanced_adventure_core:entities/wildling_guardian/behavior/phase/3/shot_small_projectile
