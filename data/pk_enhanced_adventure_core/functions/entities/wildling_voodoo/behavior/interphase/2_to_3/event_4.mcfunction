# Summon shield
summon creeper ~ ~-0.5 ~ {NoGravity:1b,Silent:1b,Invulnerable:1b,NoAI:1b,powered:1b,ExplosionRadius:0b,Tags:["pk_enhanced_adventure_mob","pk_wildling_voodoo_shield_part","pk_wildling_voodoo_fight_relative"],ActiveEffects:[{Id:14,Amplifier:1b,Duration:2147483647,ShowParticles:1b}]}
summon creeper ~ ~0.5 ~ {NoGravity:1b,Silent:1b,Invulnerable:1b,NoAI:1b,powered:1b,ExplosionRadius:0b,Tags:["pk_enhanced_adventure_mob","pk_wildling_voodoo_shield_part","pk_wildling_voodoo_fight_relative"],ActiveEffects:[{Id:14,Amplifier:1b,Duration:2147483647,ShowParticles:1b}]}
summon creeper ~ ~1.5 ~ {NoGravity:1b,Silent:1b,Invulnerable:1b,NoAI:1b,powered:1b,ExplosionRadius:0b,Tags:["pk_enhanced_adventure_mob","pk_wildling_voodoo_shield_part","pk_wildling_voodoo_fight_relative"],ActiveEffects:[{Id:14,Amplifier:1b,Duration:2147483647,ShowParticles:1b}]}
# Animations
