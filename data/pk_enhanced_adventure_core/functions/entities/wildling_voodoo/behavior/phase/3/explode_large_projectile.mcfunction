...
execute positioned ~-1.5 ~-1.5 ~-1.5 as @e[type=wither_skeleton,tag=pk_wildling_voodoo,dx=2,dy=2,dz=2,limit=1] run function pk_enhanced_adventure_core:entities/wildling_voodoo/behavior/phase/3/reduce_shield_level
