...
execute as @a[tag=pk_target_player] facing entity @s eyes run function pk_enhanced_adventure_core:entities/wildling_voodoo/behavior/phase/3/shot_large_projectile
