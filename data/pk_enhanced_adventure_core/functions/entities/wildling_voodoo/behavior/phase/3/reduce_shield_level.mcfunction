...
tp @e[type=creeper,tag=pk_wildling_voodoo_shield_part,distance=..5,limit=1] ~ -1000 ~
...
execute if entity @s[scores={pk.enhanced_adventure.boss.shield_level=0}] run function pk_enhanced_adventure_core:entities/wildling_voodoo/behavior/interphase/3_to_4/init