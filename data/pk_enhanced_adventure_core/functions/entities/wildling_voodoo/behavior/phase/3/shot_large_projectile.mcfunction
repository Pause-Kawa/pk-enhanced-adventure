...
summon fireball ^ ^ ^0.5 {ExplosionPower:0b,Tags:["pk_wildling_voodoo_projectile","pk_large","pk_current_projectile"],Item:{id:"minecraft:magma_cream",Count:1b,tag:{Enchantments:[{id:"minecraft:sharpness",lvl:1s}]}},Passengers:[{id:"minecraft:marker",Tags:["pk_wildling_voodoo_projectile_marker","pk_large"]}]}
