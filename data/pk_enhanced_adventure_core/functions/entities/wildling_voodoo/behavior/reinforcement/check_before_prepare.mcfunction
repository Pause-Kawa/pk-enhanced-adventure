...
execute if score %pk_temp_should_skip pk.common.value matches 1 run function pk_enhanced_adventure_core:entities/wildling_voodoo/behavior/reinforcement/skip
execute if score %pk_temp_should_skip pk.common.value matches 0 run function pk_enhanced_adventure_core:entities/wildling_voodoo/behavior/reinforcement/start_prepare