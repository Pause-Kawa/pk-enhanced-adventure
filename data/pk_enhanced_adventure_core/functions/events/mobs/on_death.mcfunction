...
execute if data storage pk_enhanced_adventure:data Temp.Entity.Item.tag{pkWildlingVoodoo:1b} run function pk_enhanced_adventure_core:entities/wildling_voodoo/behavior/on_death
