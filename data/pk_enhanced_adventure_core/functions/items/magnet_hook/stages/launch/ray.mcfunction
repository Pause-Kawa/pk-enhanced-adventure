...
execute unless block ~ ~ ~ #pk_enhanced_adventure_core:magnet_hook_traversable run function pk_enhanced_adventure_core:items/magnet_hook/stages/launch/hit_block
