...
execute at @e[type=minecraft:marker,tag=pk.iris.ray.found_block] run function pk_enhanced_adventure_core:mechanics/ancient_altar/states/before_use/check
