...
execute if data storage pk_enhanced_adventure:data AncientAltar.Gui.LockedSlots[0] run function pk_enhanced_adventure_core:mechanics/ancient_altar/states/in_use/content_changed/locked_slots/user_placed_undesired_item
