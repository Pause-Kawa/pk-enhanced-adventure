...
execute if score %pk_temp pk.common.value matches 1 run function pk_enhanced_adventure_core:mechanics/ancient_altar/states/in_use/content_changed/check
...
execute unless block ~ ~ ~ barrel[open=true] run function pk_enhanced_adventure_core:mechanics/ancient_altar/states/in_use/close
execute unless entity @p[tag=pk_current_player] run function pk_enhanced_adventure_core:mechanics/ancient_altar/states/in_use/close
