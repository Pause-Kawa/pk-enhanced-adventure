...
execute as @e[type=#pk_enhanced_adventure_core:mobs,limit=1,sort=nearest,tag=!pk_enhanced_adventure_data_applied] run function pk_enhanced_adventure_strc:common_structures/mechanics/common_engines/apply_data_to_entity
