...
summon marker ~ ~ ~10 {Tags:["pk_enhanced_adventure_strc_marker","pk_common_marker","pk_fight_engine"],data:{Entities:[{Type:"wildling_skeleton_axeman"}],Reinforcing:[{Type:"wildling_skeleton_archer"}],ReinforcingMax:3,SpawnAnimations:[{Particles:"soul_fire_flame"},{Sound:"entity.evoker.cast_spell"}],BeforeStart:{Events:[{Name:"wildlings_temple_boss_room"}],Delay:80},OnStart:{Events:[{Name:"wildlings_temple_boss_room"}]},BeforeStop:{Events:[{Name:"wildlings_temple_boss_room"}],Delay:80},OnStop:{Events:[{Name:"wildlings_temple_boss_room"}]},OnReset:{Events:[{Name:"wildlings_temple_boss_room"}]},Resetable:1b,TriggerValue:11}}

summon marker ~ ~ ~10 {Tags:["pk_enhanced_adventure_strc_marker","pk_common_marker","pk_fight_engine"],data:{Entities:[{Type:"wildling_skeleton_axeman"}],Reinforcing:[{Type:"wildling_skeleton_archer"}],ReinforcingMax:3,SpawnAnimations:[{Particles:"soul_fire_flame"},{Sound:"entity.evoker.cast_spell"}],BeforeStart:{Events:[{Name:"wildlings_temple_boss_room"}],Delay:20},OnStart:{Events:[{Name:"wildlings_temple_boss_room"}]},BeforeStop:{Events:[{Name:"wildlings_temple_boss_room"}],Delay:20},OnStop:{},OnReset:{},Resetable:1b,TriggerValue:1}}
