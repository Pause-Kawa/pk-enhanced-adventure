...
# Events dispatcher
execute if data storage pk_enhanced_adventure:data Temp.Engine.BeforeStart.Events[{Name:"wildling_voodoo_before_start"}] run function pk_enhanced_adventure_strc:structures/wildlings_temple/events/fight_engine/before_start/wildling_voodoo_before_start