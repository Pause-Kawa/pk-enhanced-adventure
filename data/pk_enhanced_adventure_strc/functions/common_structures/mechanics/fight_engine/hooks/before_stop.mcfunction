...
# Events dispatcher
execute if data storage pk_enhanced_adventure:data Temp.Engine.BeforeStop.Events[{Name:"higuru_guardian_before_stop"}] run function pk_enhanced_adventure_strc:structures/higuru_temple/events/fight_engine/before_stop/higuru_guardian_before_stop