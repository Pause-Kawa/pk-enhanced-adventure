...
execute if data storage pk_enhanced_adventure:data Temp.Engine.OnReset.Events[{Name:"wildling_voodoo_reset"}] run function pk_enhanced_adventure_strc:structures/wildlings_temple/events/fight_engine/on_reset/wildling_voodoo_reset