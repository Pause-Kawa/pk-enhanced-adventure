...
execute if data storage pk_enhanced_adventure:data FightEngine.EventsBeforeStart run function pk_enhanced_adventure_strc:common_structures/mechanics/fight_engine/hooks/before_start
execute unless data storage pk_enhanced_adventure:data FightEngine.EventsBeforeStart run function pk_enhanced_adventure_strc:common_structures/mechanics/fight_engine/stages/start