...
execute as @e[type=#pk_enhanced_adventure_core:tracked_mobs,tag=pk_spawner_engine_relative_entity,distance=..50] if score @s pk.enhanced_adventure.trigger.value = %pk_temp pk.enhanced_adventure.trigger.value run scoreboard players add %pk_temp pk.enhanced_adventure.counter 1
