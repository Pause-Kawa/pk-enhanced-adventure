...
# Generator
execute if entity @s[tag=pk_strc_generator] unless score %pk_enhanced_adventure_prevent_generation pk.common.value matches 1 run function pk_enhanced_adventure_strc:structures/higuru_temple/generation/generate
